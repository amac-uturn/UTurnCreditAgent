#!/usr/bin/env python3
"""
Deployment script for Account Agent
"""
...
# Configuration
REGION = "us-east-1"
AGENT_NAME = "uturn_account_agent"
ENTRYPOINT = "./account_agent.py"

def main():
    print("=" * 70)
    print("  UTurn Account Agent Deployment")
    print("=" * 70)
    ...
    try:
        ...
        print("\nThe Account Agent is now deployed and ready to handle:")
        print("  • Account balance inquiries")
        print("  • Transaction history retrieval")
        print("  • Payment processing")
        print("  • Statement generation")
        print("  • Rewards balance management")
        print("  • Autopay configuration")
