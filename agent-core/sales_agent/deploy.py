#!/usr/bin/env python3
"""
Deployment script for Sales Agent
"""
...
# Configuration
REGION = "us-east-1"
AGENT_NAME = "uturn_sales_agent"
ENTRYPOINT = "./sales_agent.py"

def main():
    print("=" * 70)
    print("  UTurn Sales Agent Deployment")
    print("=" * 70)
    ...
    try:
        ...
        print("\nThe Sales Agent is now deployed and ready to handle:")
        print("  • Product catalog browsing")
        print("  • Credit card eligibility checks")
